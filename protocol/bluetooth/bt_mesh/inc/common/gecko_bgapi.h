...
enum gecko_msg_idx
{
    ...
    gecko_cmd_mesh_debug_dump_keys_idx=185,
    gecko_cmd_mesh_debug_prov_dump_database_idx=186,
    gecko_cmd_mesh_debug_prov_load_database_entries_idx=187,
    gecko_cmd_mesh_debug_set_mask_idx=188,
    gecko_cmd_mesh_debug_set_kludges_idx=189,
    gecko_cmd_mesh_debug_rssi_limit_set_idx=190,
    gecko_cmd_mesh_debug_add_va_idx=191,
    gecko_cmd_mesh_debug_unref_va_idx=192,
    gecko_cmd_mesh_debug_dump_va_idx=193,
    gecko_cmd_mesh_debug_set_white_list_item_idx=194,
    gecko_cmd_mesh_debug_set_white_list_active_idx=195,
    gecko_cmd_mesh_debug_node_set_static_oob_data_idx=196,
    gecko_cmd_mesh_debug_node_set_oob_eckey_idx=197,
    gecko_cmd_mesh_debug_node_get_oob_eckey_idx=198,
    gecko_cmd_mesh_debug_node_get_static_oob_data_idx=199,
    gecko_cmd_mesh_debug_network_trace_config_idx=200,
    gecko_cmd_mesh_debug_network_update_idx=201,
    gecko_cmd_mesh_debug_appkey_update_idx=202,
    gecko_cmd_mesh_debug_proxy_listen_idx=203,
    gecko_cmd_mesh_debug_set_scan_idx=204,
    gecko_cmd_mesh_debug_node_set_oob_uri_idx=205,
    gecko_cmd_mesh_debug_node_get_oob_uri_idx=206,
    gecko_cmd_mesh_debug_node_init_cfgcl_idx=207,
    gecko_cmd_mesh_debug_key_refresh_start_noauto_idx=208,
    gecko_cmd_mesh_debug_key_refresh_next_phase_idx=209,
    gecko_cmd_mesh_debug_net_send_idx=210,
    gecko_cmd_proxy_radio_proxy_send_adv_idx=211,
    gecko_cmd_proxy_radio_child_adv_req_done_idx=212,
    gecko_cmd_proxy_radio_child_adv_data_idx=213,
    gecko_cmd_proxy_radio_get_ms_ticks_idx=214,
    gecko_cmd_proxy_radio_test_timer_idx=215,
    gecko_cmd_mesh_proxy_connect_idx=216,
    gecko_cmd_mesh_proxy_disconnect_idx=217,
    gecko_cmd_mesh_proxy_set_filter_type_idx=218,
    gecko_cmd_mesh_proxy_allow_idx=219,
    gecko_cmd_mesh_proxy_deny_idx=220,
    gecko_cmd_mesh_vendor_model_send_idx=221,
    gecko_cmd_mesh_vendor_model_set_publication_idx=222,
    gecko_cmd_mesh_vendor_model_clear_publication_idx=223,
    gecko_cmd_mesh_vendor_model_publish_idx=224,
    gecko_cmd_mesh_vendor_model_init_idx=225,
    gecko_cmd_mesh_vendor_model_deinit_idx=226,
    gecko_cmd_mesh_health_client_get_idx=227,
    gecko_cmd_mesh_health_client_clear_idx=228,
    gecko_cmd_mesh_health_client_test_idx=229,
    gecko_cmd_mesh_health_client_get_period_idx=230,
    gecko_cmd_mesh_health_client_set_period_idx=231,
    gecko_cmd_mesh_health_client_get_attention_idx=232,
    gecko_cmd_mesh_health_client_set_attention_idx=233,
    gecko_cmd_mesh_health_server_set_fault_idx=234,
    gecko_cmd_mesh_health_server_clear_fault_idx=235,
    gecko_cmd_mesh_health_server_test_response_idx=236,
    gecko_cmd_mesh_srtest_client_init_idx=237,
    gecko_cmd_mesh_srtest_client_deinit_idx=238,
    gecko_cmd_mesh_srtest_client_run_idx=239,
    gecko_cmd_mesh_srtest_client_stop_idx=240,
    gecko_cmd_mesh_srtest_client_status_idx=241,
    gecko_cmd_mesh_srtest_client_statistics_idx=242,
    gecko_cmd_mesh_srtest_server_init_idx=243,
    gecko_cmd_mesh_srtest_server_deinit_idx=244,
    gecko_cmd_mesh_srtest_server_statistics_idx=245,
    gecko_cmd_mesh_generic_client_get_idx=246,
    gecko_cmd_mesh_generic_client_set_idx=247,
    gecko_cmd_mesh_generic_client_publish_idx=248,
    gecko_cmd_mesh_generic_client_get_params_idx=249,
    gecko_cmd_mesh_generic_client_init_idx=250,
    gecko_cmd_mesh_generic_server_response_idx=251,
    gecko_cmd_mesh_generic_server_update_idx=252,
    gecko_cmd_mesh_generic_server_publish_idx=253,
    gecko_cmd_mesh_generic_server_init_idx=254,
    gecko_cmd_coex_set_options_idx=255,
    gecko_cmd_coex_get_counters_idx=256,
    gecko_cmd_mesh_test_get_nettx_idx=257,
    gecko_cmd_mesh_test_set_nettx_idx=258,
    gecko_cmd_mesh_test_get_relay_idx=259,
    gecko_cmd_mesh_test_set_relay_idx=260,
    gecko_cmd_mesh_test_set_adv_scan_params_idx=261,
    gecko_cmd_mesh_test_set_ivupdate_test_mode_idx=262,
    gecko_cmd_mesh_test_get_ivupdate_test_mode_idx=263,
    gecko_cmd_mesh_test_set_segment_send_delay_idx=264,
    gecko_cmd_mesh_test_set_ivupdate_state_idx=265,
    gecko_cmd_mesh_test_send_beacons_idx=266,
    gecko_cmd_mesh_test_bind_local_model_app_idx=267,
    gecko_cmd_mesh_test_unbind_local_model_app_idx=268,
    gecko_cmd_mesh_test_add_local_model_sub_idx=269,
    gecko_cmd_mesh_test_del_local_model_sub_idx=270,
    gecko_cmd_mesh_test_add_local_model_sub_va_idx=271,
    gecko_cmd_mesh_test_del_local_model_sub_va_idx=272,
    gecko_cmd_mesh_test_get_local_model_sub_idx=273,
    gecko_cmd_mesh_test_set_local_model_pub_idx=274,
    gecko_cmd_mesh_test_set_local_model_pub_va_idx=275,
    gecko_cmd_mesh_test_get_local_model_pub_idx=276,
    gecko_cmd_mesh_test_set_local_heartbeat_subscription_idx=277,
    gecko_cmd_mesh_test_get_local_heartbeat_subscription_idx=278,
    gecko_cmd_mesh_test_get_local_heartbeat_publication_idx=279,
    gecko_cmd_mesh_test_set_local_heartbeat_publication_idx=280,
    gecko_cmd_mesh_test_set_local_config_idx=281,
    gecko_cmd_mesh_test_get_local_config_idx=282,
    gecko_cmd_mesh_test_add_local_key_idx=283,
    gecko_cmd_mesh_test_del_local_key_idx=284,
    gecko_cmd_mesh_test_update_local_key_idx=285,
    gecko_cmd_mesh_test_set_sar_config_idx=286,
    gecko_cmd_mesh_test_get_element_seqnum_idx=287,
    gecko_cmd_mesh_lpn_init_idx=288,
    gecko_cmd_mesh_lpn_deinit_idx=289,
    gecko_cmd_mesh_lpn_configure_idx=290,
    gecko_cmd_mesh_lpn_establish_friendship_idx=291,
    gecko_cmd_mesh_lpn_poll_idx=292,
    gecko_cmd_mesh_lpn_terminate_friendship_idx=293,
    gecko_cmd_mesh_friend_init_idx=294,
    gecko_cmd_mesh_friend_deinit_idx=295,
    gecko_cmd_user_message_to_target_idx=296,

    gecko_rsp_dfu_flash_set_address_idx=297,
    gecko_rsp_dfu_flash_upload_idx=298,
    gecko_rsp_dfu_flash_upload_finish_idx=299,
    gecko_rsp_system_hello_idx=300,
    gecko_rsp_system_get_bt_address_idx=301,
    gecko_rsp_system_set_bt_address_idx=302,
    gecko_rsp_system_set_tx_power_idx=303,
    gecko_rsp_system_get_random_data_idx=304,
    gecko_rsp_system_halt_idx=305,
    gecko_rsp_system_set_device_name_idx=306,
    gecko_rsp_system_linklayer_configure_idx=307,
    gecko_rsp_system_get_counters_idx=308,
    gecko_rsp_le_gap_open_idx=309,
    gecko_rsp_le_gap_set_mode_idx=310,
    gecko_rsp_le_gap_discover_idx=311,
    gecko_rsp_le_gap_end_procedure_idx=312,
    gecko_rsp_le_gap_set_adv_parameters_idx=313,
    gecko_rsp_le_gap_set_conn_parameters_idx=314,
    gecko_rsp_le_gap_set_scan_parameters_idx=315,
    gecko_rsp_le_gap_set_adv_data_idx=316,
    gecko_rsp_le_gap_set_adv_timeout_idx=317,
    gecko_rsp_le_gap_set_phy_idx=318,
    gecko_rsp_le_gap_bt5_set_mode_idx=319,
    gecko_rsp_le_gap_bt5_set_adv_parameters_idx=320,
    gecko_rsp_le_gap_bt5_set_adv_data_idx=321,
    gecko_rsp_le_gap_set_privacy_mode_idx=322,
    gecko_rsp_le_gap_set_advertise_timing_idx=323,
    gecko_rsp_le_gap_set_advertise_channel_map_idx=324,
    gecko_rsp_le_gap_set_advertise_report_scan_request_idx=325,
    gecko_rsp_le_gap_set_advertise_phy_idx=326,
    gecko_rsp_le_gap_set_advertise_configuration_idx=327,
    gecko_rsp_le_gap_clear_advertise_configuration_idx=328,
    gecko_rsp_le_gap_start_advertising_idx=329,
    gecko_rsp_le_gap_stop_advertising_idx=330,
    gecko_rsp_le_gap_set_discovery_timing_idx=331,
    gecko_rsp_le_gap_set_discovery_type_idx=332,
    gecko_rsp_le_gap_start_discovery_idx=333,
    gecko_rsp_le_gap_set_data_channel_classification_idx=334,
    gecko_rsp_le_gap_connect_idx=335,
    gecko_rsp_le_gap_set_advertise_tx_power_idx=336,
    gecko_rsp_le_connection_set_parameters_idx=337,
    gecko_rsp_le_connection_get_rssi_idx=338,
    gecko_rsp_le_connection_disable_slave_latency_idx=339,
    gecko_rsp_le_connection_set_phy_idx=340,
    gecko_rsp_le_connection_close_idx=341,
    gecko_rsp_gatt_set_max_mtu_idx=342,
    gecko_rsp_gatt_discover_primary_services_idx=343,
    gecko_rsp_gatt_discover_primary_services_by_uuid_idx=344,
    gecko_rsp_gatt_discover_characteristics_idx=345,
    gecko_rsp_gatt_discover_characteristics_by_uuid_idx=346,
    gecko_rsp_gatt_set_characteristic_notification_idx=347,
    gecko_rsp_gatt_discover_descriptors_idx=348,
    gecko_rsp_gatt_read_characteristic_value_idx=349,
    gecko_rsp_gatt_read_characteristic_value_by_uuid_idx=350,
    gecko_rsp_gatt_write_characteristic_value_idx=351,
    gecko_rsp_gatt_write_characteristic_value_without_response_idx=352,
    gecko_rsp_gatt_prepare_characteristic_value_write_idx=353,
    gecko_rsp_gatt_execute_characteristic_value_write_idx=354,
    gecko_rsp_gatt_send_characteristic_confirmation_idx=355,
    gecko_rsp_gatt_read_descriptor_value_idx=356,
    gecko_rsp_gatt_write_descriptor_value_idx=357,
    gecko_rsp_gatt_find_included_services_idx=358,
    gecko_rsp_gatt_read_multiple_characteristic_values_idx=359,
    gecko_rsp_gatt_read_characteristic_value_from_offset_idx=360,
    gecko_rsp_gatt_prepare_characteristic_value_reliable_write_idx=361,
    gecko_rsp_gatt_server_read_attribute_value_idx=362,
    gecko_rsp_gatt_server_read_attribute_type_idx=363,
    gecko_rsp_gatt_server_write_attribute_value_idx=364,
    gecko_rsp_gatt_server_send_user_read_response_idx=365,
    gecko_rsp_gatt_server_send_user_write_response_idx=366,
    gecko_rsp_gatt_server_send_characteristic_notification_idx=367,
    gecko_rsp_gatt_server_find_attribute_idx=368,
    gecko_rsp_gatt_server_set_database_idx=369,
    gecko_rsp_gatt_server_set_capabilities_idx=370,
    gecko_rsp_endpoint_close_idx=371,
    gecko_rsp_hardware_set_soft_timer_idx=372,
    gecko_rsp_hardware_get_time_idx=373,
    gecko_rsp_hardware_set_lazy_soft_timer_idx=374,
    gecko_rsp_hardware_enable_dcdc_idx=375,
    gecko_rsp_flash_ps_erase_all_idx=376,
    gecko_rsp_flash_ps_save_idx=377,
    gecko_rsp_flash_ps_load_idx=378,
    gecko_rsp_flash_ps_erase_idx=379,
    gecko_rsp_test_dtm_tx_idx=380,
    gecko_rsp_test_dtm_rx_idx=381,
    gecko_rsp_test_dtm_end_idx=382,
    gecko_rsp_test_debug_command_idx=383,
    gecko_rsp_test_debug_counter_idx=384,
    gecko_rsp_sm_set_bondable_mode_idx=385,
    gecko_rsp_sm_configure_idx=386,
    gecko_rsp_sm_store_bonding_configuration_idx=387,
    gecko_rsp_sm_increase_security_idx=388,
    gecko_rsp_sm_delete_bonding_idx=389,
    gecko_rsp_sm_delete_bondings_idx=390,
    gecko_rsp_sm_enter_passkey_idx=391,
    gecko_rsp_sm_passkey_confirm_idx=392,
    gecko_rsp_sm_set_oob_data_idx=393,
    gecko_rsp_sm_list_all_bondings_idx=394,
    gecko_rsp_sm_bonding_confirm_idx=395,
    gecko_rsp_sm_set_debug_mode_idx=396,
    gecko_rsp_sm_set_passkey_idx=397,
    gecko_rsp_sm_use_sc_oob_idx=398,
    gecko_rsp_sm_set_sc_remote_oob_data_idx=399,
    gecko_rsp_homekit_configure_idx=400,
    gecko_rsp_homekit_advertise_idx=401,
    gecko_rsp_homekit_delete_pairings_idx=402,
    gecko_rsp_homekit_check_authcp_idx=403,
    gecko_rsp_homekit_get_pairing_id_idx=404,
    gecko_rsp_homekit_send_write_response_idx=405,
    gecko_rsp_homekit_send_read_response_idx=406,
    gecko_rsp_homekit_gsn_action_idx=407,
    gecko_rsp_homekit_event_notification_idx=408,
    gecko_rsp_homekit_broadcast_action_idx=409,
    gecko_rsp_mesh_node_init_idx=410,
    gecko_rsp_mesh_node_start_unprov_beaconing_idx=411,
    gecko_rsp_mesh_node_input_oob_request_rsp_idx=412,
    gecko_rsp_mesh_node_get_uuid_idx=413,
    gecko_rsp_mesh_node_set_provisioning_data_idx=414,
    gecko_rsp_mesh_node_init_oob_idx=415,
    gecko_rsp_mesh_node_set_ivrecovery_mode_idx=416,
    gecko_rsp_mesh_node_get_ivrecovery_mode_idx=417,
    gecko_rsp_mesh_node_set_adv_event_filter_idx=418,
    gecko_rsp_mesh_node_get_statistics_idx=419,
    gecko_rsp_mesh_node_clear_statistics_idx=420,
    gecko_rsp_mesh_node_set_net_relay_delay_idx=421,
    gecko_rsp_mesh_node_get_net_relay_delay_idx=422,
    gecko_rsp_mesh_node_get_ivupdate_state_idx=423,
    gecko_rsp_mesh_node_request_ivupdate_idx=424,
    gecko_rsp_mesh_node_get_seq_remaining_idx=425,
    gecko_rsp_mesh_node_save_replay_protection_list_idx=426,
    gecko_rsp_mesh_node_set_uuid_idx=427,
    gecko_rsp_mesh_node_get_element_address_idx=428,
    gecko_rsp_mesh_node_static_oob_request_rsp_idx=429,
    gecko_rsp_mesh_prov_init_idx=430,
    gecko_rsp_mesh_prov_scan_unprov_beacons_idx=431,
    gecko_rsp_mesh_prov_provision_device_idx=432,
    gecko_rsp_mesh_prov_create_network_idx=433,
    gecko_rsp_mesh_prov_get_dcd_idx=434,
    gecko_rsp_mesh_prov_get_config_idx=435,
    gecko_rsp_mesh_prov_set_config_idx=436,
    gecko_rsp_mesh_prov_create_appkey_idx=437,
    gecko_rsp_mesh_prov_oob_pkey_rsp_idx=438,
    gecko_rsp_mesh_prov_oob_auth_rsp_idx=439,
    gecko_rsp_mesh_prov_set_oob_requirements_idx=440,
    gecko_rsp_mesh_prov_key_refresh_start_idx=441,
    gecko_rsp_mesh_prov_get_key_refresh_blacklist_idx=442,
    gecko_rsp_mesh_prov_set_key_refresh_blacklist_idx=443,
    gecko_rsp_mesh_prov_appkey_add_idx=444,
    gecko_rsp_mesh_prov_appkey_delete_idx=445,
    gecko_rsp_mesh_prov_model_app_bind_idx=446,
    gecko_rsp_mesh_prov_model_app_unbind_idx=447,
    gecko_rsp_mesh_prov_model_app_get_idx=448,
    gecko_rsp_mesh_prov_model_sub_add_idx=449,
    gecko_rsp_mesh_prov_model_pub_set_idx=450,
    gecko_rsp_mesh_prov_provision_gatt_device_idx=451,
    gecko_rsp_mesh_prov_ddb_get_idx=452,
    gecko_rsp_mesh_prov_ddb_delete_idx=453,
    gecko_rsp_mesh_prov_ddb_add_idx=454,
    gecko_rsp_mesh_prov_ddb_list_devices_idx=455,
    gecko_rsp_mesh_prov_network_add_idx=456,
    gecko_rsp_mesh_prov_network_delete_idx=457,
    gecko_rsp_mesh_prov_nettx_get_idx=458,
    gecko_rsp_mesh_prov_nettx_set_idx=459,
    gecko_rsp_mesh_prov_model_sub_del_idx=460,
    gecko_rsp_mesh_prov_model_sub_add_va_idx=461,
    gecko_rsp_mesh_prov_model_sub_del_va_idx=462,
    gecko_rsp_mesh_prov_model_sub_set_idx=463,
    gecko_rsp_mesh_prov_model_sub_set_va_idx=464,
    gecko_rsp_mesh_prov_heartbeat_publication_get_idx=465,
    gecko_rsp_mesh_prov_heartbeat_publication_set_idx=466,
    gecko_rsp_mesh_prov_heartbeat_subscription_get_idx=467,
    gecko_rsp_mesh_prov_heartbeat_subscription_set_idx=468,
    gecko_rsp_mesh_prov_relay_get_idx=469,
    gecko_rsp_mesh_prov_relay_set_idx=470,
    gecko_rsp_mesh_prov_reset_node_idx=471,
    gecko_rsp_mesh_prov_appkey_get_idx=472,
    gecko_rsp_mesh_prov_network_get_idx=473,
    gecko_rsp_mesh_prov_model_sub_clear_idx=474,
    gecko_rsp_mesh_prov_model_pub_get_idx=475,
    gecko_rsp_mesh_prov_model_pub_set_va_idx=476,
    gecko_rsp_mesh_prov_model_pub_set_cred_idx=477,
    gecko_rsp_mesh_prov_model_pub_set_va_cred_idx=478,
    gecko_rsp_mesh_prov_model_sub_get_idx=479,
    gecko_rsp_mesh_debug_dump_keys_idx=480,
    gecko_rsp_mesh_debug_prov_dump_database_idx=481,
    gecko_rsp_mesh_debug_prov_load_database_entries_idx=482,
    gecko_rsp_mesh_debug_set_mask_idx=483,
    gecko_rsp_mesh_debug_set_kludges_idx=484,
    gecko_rsp_mesh_debug_rssi_limit_set_idx=485,
    gecko_rsp_mesh_debug_add_va_idx=486,
    gecko_rsp_mesh_debug_unref_va_idx=487,
    gecko_rsp_mesh_debug_dump_va_idx=488,
    gecko_rsp_mesh_debug_set_white_list_item_idx=489,
    gecko_rsp_mesh_debug_set_white_list_active_idx=490,
    gecko_rsp_mesh_debug_node_set_static_oob_data_idx=491,
    gecko_rsp_mesh_debug_node_set_oob_eckey_idx=492,
    gecko_rsp_mesh_debug_node_get_oob_eckey_idx=493,
    gecko_rsp_mesh_debug_node_get_static_oob_data_idx=494,
    gecko_rsp_mesh_debug_network_trace_config_idx=495,
    gecko_rsp_mesh_debug_network_update_idx=496,
    gecko_rsp_mesh_debug_appkey_update_idx=497,
    gecko_rsp_mesh_debug_proxy_listen_idx=498,
    gecko_rsp_mesh_debug_set_scan_idx=499,
    gecko_rsp_mesh_debug_node_set_oob_uri_idx=500,
    gecko_rsp_mesh_debug_node_get_oob_uri_idx=501,
    gecko_rsp_mesh_debug_node_init_cfgcl_idx=502,
    gecko_rsp_mesh_debug_key_refresh_start_noauto_idx=503,
    gecko_rsp_mesh_debug_key_refresh_next_phase_idx=504,
    gecko_rsp_mesh_debug_net_send_idx=505,
    gecko_rsp_proxy_radio_proxy_send_adv_idx=506,
    gecko_rsp_proxy_radio_child_adv_req_done_idx=507,
    gecko_rsp_proxy_radio_child_adv_data_idx=508,
    gecko_rsp_proxy_radio_get_ms_ticks_idx=509,
    gecko_rsp_proxy_radio_test_timer_idx=510,
    gecko_rsp_mesh_proxy_connect_idx=511,
    gecko_rsp_mesh_proxy_disconnect_idx=512,
    gecko_rsp_mesh_proxy_set_filter_type_idx=513,
    gecko_rsp_mesh_proxy_allow_idx=514,
    gecko_rsp_mesh_proxy_deny_idx=515,
    gecko_rsp_mesh_vendor_model_send_idx=516,
    gecko_rsp_mesh_vendor_model_set_publication_idx=517,
    gecko_rsp_mesh_vendor_model_clear_publication_idx=518,
    gecko_rsp_mesh_vendor_model_publish_idx=519,
    gecko_rsp_mesh_vendor_model_init_idx=520,
    gecko_rsp_mesh_vendor_model_deinit_idx=521,
    gecko_rsp_mesh_health_client_get_idx=522,
    gecko_rsp_mesh_health_client_clear_idx=523,
    gecko_rsp_mesh_health_client_test_idx=524,
    gecko_rsp_mesh_health_client_get_period_idx=525,
    gecko_rsp_mesh_health_client_set_period_idx=526,
    gecko_rsp_mesh_health_client_get_attention_idx=527,
    gecko_rsp_mesh_health_client_set_attention_idx=528,
    gecko_rsp_mesh_health_server_set_fault_idx=529,
    gecko_rsp_mesh_health_server_clear_fault_idx=530,
    gecko_rsp_mesh_health_server_test_response_idx=531,
    gecko_rsp_mesh_srtest_client_init_idx=532,
    gecko_rsp_mesh_srtest_client_deinit_idx=533,
    gecko_rsp_mesh_srtest_client_run_idx=534,
    gecko_rsp_mesh_srtest_client_stop_idx=535,
    gecko_rsp_mesh_srtest_client_status_idx=536,
    gecko_rsp_mesh_srtest_client_statistics_idx=537,
    gecko_rsp_mesh_srtest_server_init_idx=538,
    gecko_rsp_mesh_srtest_server_deinit_idx=539,
    gecko_rsp_mesh_srtest_server_statistics_idx=540,
    gecko_rsp_mesh_generic_client_get_idx=541,
    gecko_rsp_mesh_generic_client_set_idx=542,
    gecko_rsp_mesh_generic_client_publish_idx=543,
    gecko_rsp_mesh_generic_client_get_params_idx=544,
    gecko_rsp_mesh_generic_client_init_idx=545,
    gecko_rsp_mesh_generic_server_response_idx=546,
    gecko_rsp_mesh_generic_server_update_idx=547,
    gecko_rsp_mesh_generic_server_publish_idx=548,
    gecko_rsp_mesh_generic_server_init_idx=549,
    gecko_rsp_coex_set_options_idx=550,
    gecko_rsp_coex_get_counters_idx=551,
    gecko_rsp_mesh_test_get_nettx_idx=552,
    gecko_rsp_mesh_test_set_nettx_idx=553,
    gecko_rsp_mesh_test_get_relay_idx=554,
    gecko_rsp_mesh_test_set_relay_idx=555,
    gecko_rsp_mesh_test_set_adv_scan_params_idx=556,
    gecko_rsp_mesh_test_set_ivupdate_test_mode_idx=557,
    gecko_rsp_mesh_test_get_ivupdate_test_mode_idx=558,
    gecko_rsp_mesh_test_set_segment_send_delay_idx=559,
    gecko_rsp_mesh_test_set_ivupdate_state_idx=560,
    gecko_rsp_mesh_test_send_beacons_idx=561,
    gecko_rsp_mesh_test_bind_local_model_app_idx=562,
    gecko_rsp_mesh_test_unbind_local_model_app_idx=563,
    gecko_rsp_mesh_test_add_local_model_sub_idx=564,
    gecko_rsp_mesh_test_del_local_model_sub_idx=565,
    gecko_rsp_mesh_test_add_local_model_sub_va_idx=566,
    gecko_rsp_mesh_test_del_local_model_sub_va_idx=567,
    gecko_rsp_mesh_test_get_local_model_sub_idx=568,
    gecko_rsp_mesh_test_set_local_model_pub_idx=569,
    gecko_rsp_mesh_test_set_local_model_pub_va_idx=570,
    gecko_rsp_mesh_test_get_local_model_pub_idx=571,
    gecko_rsp_mesh_test_set_local_heartbeat_subscription_idx=572,
    gecko_rsp_mesh_test_get_local_heartbeat_subscription_idx=573,
    gecko_rsp_mesh_test_get_local_heartbeat_publication_idx=574,
    gecko_rsp_mesh_test_set_local_heartbeat_publication_idx=575,
    gecko_rsp_mesh_test_set_local_config_idx=576,
    gecko_rsp_mesh_test_get_local_config_idx=577,
    gecko_rsp_mesh_test_add_local_key_idx=578,
    gecko_rsp_mesh_test_del_local_key_idx=579,
    gecko_rsp_mesh_test_update_local_key_idx=580,
    gecko_rsp_mesh_test_set_sar_config_idx=581,
    gecko_rsp_mesh_test_get_element_seqnum_idx=582,
    gecko_rsp_mesh_lpn_init_idx=583,
    gecko_rsp_mesh_lpn_deinit_idx=584,
    gecko_rsp_mesh_lpn_configure_idx=585,
    gecko_rsp_mesh_lpn_establish_friendship_idx=586,
    gecko_rsp_mesh_lpn_poll_idx=587,
    gecko_rsp_mesh_lpn_terminate_friendship_idx=588,
    gecko_rsp_mesh_friend_init_idx=589,
    gecko_rsp_mesh_friend_deinit_idx=590,
    gecko_rsp_user_message_to_target_idx=591,

    gecko_evt_dfu_boot_idx=592,
    gecko_evt_dfu_boot_failure_idx=593,
    gecko_evt_system_boot_idx=594,
    gecko_evt_system_external_signal_idx=595,
    gecko_evt_system_awake_idx=596,
    gecko_evt_system_hardware_error_idx=597,
    gecko_evt_system_error_idx=598,
    gecko_evt_le_gap_scan_response_idx=599,
    gecko_evt_le_gap_adv_timeout_idx=600,
    gecko_evt_le_gap_scan_request_idx=601,
    gecko_evt_le_connection_opened_idx=602,
    gecko_evt_le_connection_closed_idx=603,
    gecko_evt_le_connection_parameters_idx=604,
    gecko_evt_le_connection_rssi_idx=605,
    gecko_evt_le_connection_phy_status_idx=606,
    gecko_evt_gatt_mtu_exchanged_idx=607,
    gecko_evt_gatt_service_idx=608,
    gecko_evt_gatt_characteristic_idx=609,
    gecko_evt_gatt_descriptor_idx=610,
    gecko_evt_gatt_characteristic_value_idx=611,
    gecko_evt_gatt_descriptor_value_idx=612,
    gecko_evt_gatt_procedure_completed_idx=613,
    gecko_evt_gatt_server_attribute_value_idx=614,
    gecko_evt_gatt_server_user_read_request_idx=615,
    gecko_evt_gatt_server_user_write_request_idx=616,
    gecko_evt_gatt_server_characteristic_status_idx=617,
    gecko_evt_gatt_server_execute_write_completed_idx=618,
    gecko_evt_endpoint_status_idx=619,
    gecko_evt_hardware_soft_timer_idx=620,
    gecko_evt_test_dtm_completed_idx=621,
    gecko_evt_test_hcidump_idx=622,
    gecko_evt_sm_passkey_display_idx=623,
    gecko_evt_sm_passkey_request_idx=624,
    gecko_evt_sm_confirm_passkey_idx=625,
    gecko_evt_sm_bonded_idx=626,
    gecko_evt_sm_bonding_failed_idx=627,
    gecko_evt_sm_list_bonding_entry_idx=628,
    gecko_evt_sm_list_all_bondings_complete_idx=629,
    gecko_evt_sm_confirm_bonding_idx=630,
    gecko_evt_homekit_setupcode_display_idx=631,
    gecko_evt_homekit_paired_idx=632,
    gecko_evt_homekit_pair_verified_idx=633,
    gecko_evt_homekit_connection_opened_idx=634,
    gecko_evt_homekit_connection_closed_idx=635,
    gecko_evt_homekit_identify_idx=636,
    gecko_evt_homekit_write_request_idx=637,
    gecko_evt_homekit_read_request_idx=638,
    gecko_evt_homekit_disconnection_required_idx=639,
    gecko_evt_homekit_pairing_removed_idx=640,
    gecko_evt_homekit_setuppayload_display_idx=641,
    gecko_evt_mesh_node_initialized_idx=642,
    gecko_evt_mesh_node_provisioned_idx=643,
    gecko_evt_mesh_node_config_get_idx=644,
    gecko_evt_mesh_node_config_set_idx=645,
    gecko_evt_mesh_node_display_output_oob_idx=646,
    gecko_evt_mesh_node_input_oob_request_idx=647,
    gecko_evt_mesh_node_provisioning_started_idx=648,
    gecko_evt_mesh_node_provisioning_failed_idx=649,
    gecko_evt_mesh_node_key_added_idx=650,
    gecko_evt_mesh_node_model_config_changed_idx=651,
    gecko_evt_mesh_node_reset_idx=652,
    gecko_evt_mesh_node_ivrecovery_needed_idx=653,
    gecko_evt_mesh_node_changed_ivupdate_state_idx=654,
    gecko_evt_mesh_node_static_oob_request_idx=655,
    gecko_evt_mesh_prov_initialized_idx=656,
    gecko_evt_mesh_prov_provisioning_failed_idx=657,
    gecko_evt_mesh_prov_device_provisioned_idx=658,
    gecko_evt_mesh_prov_unprov_beacon_idx=659,
    gecko_evt_mesh_prov_dcd_status_idx=660,
    gecko_evt_mesh_prov_config_status_idx=661,
    gecko_evt_mesh_prov_oob_pkey_request_idx=662,
    gecko_evt_mesh_prov_oob_auth_request_idx=663,
    gecko_evt_mesh_prov_oob_display_input_idx=664,
    gecko_evt_mesh_prov_ddb_list_idx=665,
    gecko_evt_mesh_prov_heartbeat_publication_status_idx=666,
    gecko_evt_mesh_prov_heartbeat_subscription_status_idx=667,
    gecko_evt_mesh_prov_relay_status_idx=668,
    gecko_evt_mesh_prov_uri_idx=669,
    gecko_evt_mesh_prov_node_reset_idx=670,
    gecko_evt_mesh_prov_appkey_list_idx=671,
    gecko_evt_mesh_prov_appkey_list_end_idx=672,
    gecko_evt_mesh_prov_network_list_idx=673,
    gecko_evt_mesh_prov_network_list_end_idx=674,
    gecko_evt_mesh_prov_model_pub_status_idx=675,
    gecko_evt_mesh_prov_key_refresh_phase_update_idx=676,
    gecko_evt_mesh_prov_key_refresh_node_update_idx=677,
    gecko_evt_mesh_prov_key_refresh_complete_idx=678,
    gecko_evt_mesh_prov_model_sub_addr_idx=679,
    gecko_evt_mesh_prov_model_sub_addr_end_idx=680,
    gecko_evt_mesh_debug_key_idx=681,
    gecko_evt_mesh_debug_keys_end_idx=682,
    gecko_evt_mesh_debug_msg_idx=683,
    gecko_evt_mesh_debug_prov_database_entry_idx=684,
    gecko_evt_mesh_debug_prov_database_entries_end_idx=685,
    gecko_evt_mesh_debug_va_idx=686,
    gecko_evt_mesh_debug_va_end_idx=687,
    gecko_evt_mesh_debug_network_trace_pdu_idx=688,
    gecko_evt_mesh_debug_network_trace_access_payload_idx=689,
    gecko_evt_mesh_debug_network_status_idx=690,
    gecko_evt_mesh_debug_appkey_status_idx=691,
    gecko_evt_mesh_debug_transport_rx_cancelled_idx=692,
    gecko_evt_proxy_radio_proxy_send_adv_done_idx=693,
    gecko_evt_proxy_radio_proxy_adv_data_idx=694,
    gecko_evt_proxy_radio_child_adv_req_idx=695,
    gecko_evt_proxy_radio_child_adv_params_req_idx=696,
    gecko_evt_proxy_radio_test_timer_expired_idx=697,
    gecko_evt_mesh_proxy_connected_idx=698,
    gecko_evt_mesh_proxy_disconnected_idx=699,
    gecko_evt_mesh_proxy_filter_status_idx=700,
    gecko_evt_mesh_vendor_model_receive_idx=701,
    gecko_evt_mesh_health_client_server_status_idx=702,
    gecko_evt_mesh_health_client_server_status_period_idx=703,
    gecko_evt_mesh_health_client_server_status_attention_idx=704,
    gecko_evt_mesh_health_server_attention_idx=705,
    gecko_evt_mesh_health_server_test_request_idx=706,
    gecko_evt_mesh_srtest_client_server_status_idx=707,
    gecko_evt_mesh_srtest_client_payload_received_idx=708,
    gecko_evt_mesh_srtest_server_state_changed_idx=709,
    gecko_evt_mesh_srtest_server_run_started_idx=710,
    gecko_evt_mesh_srtest_server_run_ended_idx=711,
    gecko_evt_mesh_srtest_server_statistics_dump_idx=712,
    gecko_evt_mesh_srtest_server_payload_sent_idx=713,
    gecko_evt_mesh_generic_client_server_status_idx=714,
    gecko_evt_mesh_generic_server_client_request_idx=715,
    gecko_evt_mesh_generic_server_state_changed_idx=716,
    gecko_evt_mesh_test_local_heartbeat_subscription_complete_idx=717,
    gecko_evt_mesh_lpn_friendship_established_idx=718,
    gecko_evt_mesh_lpn_friendship_failed_idx=719,
    gecko_evt_mesh_lpn_friendship_terminated_idx=720,
    gecko_evt_mesh_friend_friendship_established_idx=721,
    gecko_evt_mesh_friend_friendship_terminated_idx=722,
    gecko_evt_user_message_to_host_idx=723,
};
...
/** Send a reset request to a node.
            ...
            href="#evt_mesh_prov_node_reset"}node reset{/a} even will
            be generate. Note that the reply packet may get lost and
