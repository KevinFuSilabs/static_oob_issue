...
* @param auth_methods   Allowed OOB authentication methods
...
*
* Set node relay retransmission state. The             node will respond with a "subscription             status" event. 
*
* @param address   Unicast address of the target node
* @param netkey_index   The network key index used in encrypting                     the request. 
...
*
* Send a reset request to a node.             {br}{br}              If a node replies to the request, a "node reset" even will             be generate. Note that the reply packet may get lost and             the node has reset itself even in the absence of the             event. {br}{br}              Also note that for securely removing a node from the network             a key refresh, with the removed node blacklisted, should be             done.              
*
* @param address   Unicast address of the target node
* @param netkey_index   The network key index used in encrypting                     the request. 
*
...
* Events generated
*
* gecko_evt_mesh_prov_model_sub_status -     
*
**/
