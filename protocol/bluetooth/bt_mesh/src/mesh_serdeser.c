                               ...
                               size_t *msg_used)
{
  ...
  switch (req->kind) {
    ...
    case mesh_generic_request_location_local:
      ...
      int16_to_buf(&msg_buf[msg_off], req->location_local.uncertainty);
      msg_off += 2;
      *msg_used = msg_off;
      break;
                                 ...
                                 size_t msg_len)
{
  ...
  switch (kind) {
    ...
    case mesh_generic_request_location_local:
      ...
      req->location_local.uncertainty = int16_from_buf(&msg_buf[msg_off]);
      msg_off += 2;
      break;
                             ...
                             size_t *msg_used)
{
  ...
  switch (current->kind) {
    ...
    case mesh_generic_state_location_local:
      ...
      int16_to_buf(&msg_buf[msg_off], current->location_local.uncertainty);
      msg_off += 2;
      *msg_used = msg_off;
      break;
                               ...
                               size_t msg_len)
{
  ...
  switch (kind) {
    ...
    case mesh_generic_state_location_local:
      ...
      current->location_local.uncertainty = int16_from_buf(&msg_buf[msg_off]);
      msg_off += 2;
      *has_target = 0;
      break;
